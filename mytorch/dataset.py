...
def _resolve_list_path(data_root, list_path):
...
class AutoDriveDataset(Dataset):
    ...
    def __init__(self, mode, transform=None, data_root="./", list_path=None):
        ...
        file_path = _resolve_list_path(data_root, list_path)
    ...
    def __getitem__(self, i):
        if cv2 is None:
            raise ModuleNotFoundError("AutoDriveDataset 需要安装 opencv-python")
        """
        :参数 i: 图像检索号
